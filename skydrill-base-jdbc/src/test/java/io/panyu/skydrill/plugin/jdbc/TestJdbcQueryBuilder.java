...
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_BOOLEAN;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_DATE;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_DOUBLE;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_INTEGER;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_REAL;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_SMALLINT;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_TIME;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_TIMESTAMP;
import static io.panyu.skydrill.plugin.jdbc.TestingJdbcTypeHandle.JDBC_TINYINT;
...
public class TestJdbcQueryBuilder
{
            ...
            throws SQLException
    {
        ...
        Connection connection = database.getConnection();
        try (PreparedStatement preparedStatement = new QueryBuilder("\"").buildSql(jdbcClient, connection, "", "", "test_table", columns, tupleDomain, null);
